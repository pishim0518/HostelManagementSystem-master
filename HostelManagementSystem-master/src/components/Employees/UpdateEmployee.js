    ...
    return (
        <div>
            ...
            <input type='text' 
                ...
                required
                />
                <button onClick={handleSearchText} style={{marginright:"10px" , marginTop:"20px"}} className='btn btn-primary'>Search</button>
            <form onSubmit={handleSubmit} className='container' style={{marginLeft:"",marginTop:"30px"}} >
            <div>
                <label>Name</label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type='text' 
        ...
        <button className='btn btn-danger' style={{marginLeft:"",marginTop:"-60px"}} onClick={handleDelete}>Delete</button>
